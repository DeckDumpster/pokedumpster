...
#
# deploy/ci-parallel.sh runs twelve container gates two at a time (the default;
...
tests/lake/value_snapshots.sh tests/refresh/tenant_bytes.sh tests/keys/run.sh"
