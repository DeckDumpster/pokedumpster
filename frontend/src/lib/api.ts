...
// Collection value-history shapes (pokedumpster-e1vo) — ts-rs-generated by the
// e1vo.1 backend; re-exported so components import them from `$lib/api`.
import type { ValuePoint } from './types/ValuePoint';
import type { ValueSeries } from './types/ValueSeries';
export type { ValuePoint, ValueSeries };
