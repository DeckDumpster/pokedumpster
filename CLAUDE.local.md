...
**YOU ARE IN: `pokedumpster/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pokedumpster/` (rig root) or other directories
...
**Your mail address:** `pokedumpster/polecats/guzzle`
**Your rig:** pokedumpster
**Your Witness:** `pokedumpster/witness`
...
| Ask Witness for help | `gt mail send pokedumpster/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pokedumpster/witness`) when:
...
```bash
gt mail send pokedumpster/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
